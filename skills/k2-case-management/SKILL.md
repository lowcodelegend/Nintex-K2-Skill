...
6. Start the experience from [the canonical case UX](assets/case-ux.yaml), including its required native SmartForms Northstar homepage, extend it instead of rebuilding the shell and standard case components, and follow [the UX contract](references/ux-contract.md). Use native K2 artifacts for navigation, data, actions, rules, accessible alternatives, and persistence. Use the bounded modern command-palette and dashboard-widget controls only for the interaction and visualization gaps that native controls cannot reproduce at Northstar fidelity. Define optional AI assistance and its human oversight, solution-specific Forms, queues, dashboards, reports, permissions, retention, operations, and recovery.
