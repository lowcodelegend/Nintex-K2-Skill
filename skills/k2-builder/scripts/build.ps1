...
if ($actualVersion -cne 'k2build 0.13.0') {
...
if ($environmentVersion -cne 'k2env 0.5.0') {
    throw "Unexpected k2env version output: $environmentVersion"
}

Write-Output "k2-builder 0.13.0 validation passed ($Configuration); k2env 0.5.0 built at $environmentExecutable."
