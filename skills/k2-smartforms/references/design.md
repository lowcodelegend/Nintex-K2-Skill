...
1. The master View-owned Create event returns the generated key to the master View field; the Form invokes that event rather than cloning its method action.
